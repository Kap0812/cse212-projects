...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Finite-turn persons were not properly re-enqueued after turns were used (turns not decremented).
    ...
    // Defect(s) Found: New player was not added to the end of the queue.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Infinite-turn person (0) was not re-enqueued or had turns modified.
    ...
    // Defect(s) Found: Infinite-turn person (negative) was not re-enqueued or had turns modified.
    ...
    // Defect(s) Found: No exception was thrown for empty queue.
